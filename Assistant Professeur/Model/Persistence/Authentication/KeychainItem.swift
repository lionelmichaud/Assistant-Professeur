...
struct KeychainItem {
    ...
    func readItem() throws -> String {
        /*
         ...
         access group.
         */
        var query = KeychainItem.keychainQuery(
            withService: service,
            account: account,
    ...
    static var currentUserIdentifier: String {
        do {
            let storedIdentifier = try KeychainItem(
                service: "com.michaud.lionel.Assistant-Professeur",
    ...
    static func saveUserIdentifierToKeychain(_ userIdentifier: String) {
        do {
            try KeychainItem(
                service: "com.michaud.lionel.Assistant-Professeur",
                account: "userIdentifier"
            ...
            customLog.error(
                "Unable to save userIdentifier to keychain"
            )
        }
    }
    ...
    static func deleteUserIdentifierFromKeychain() {
        do {
            ...
            customLog.error(
                "Unable to delete userIdentifier from keychain"
            )
        }
    }
}
